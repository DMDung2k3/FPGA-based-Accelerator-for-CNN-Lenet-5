...
module CIFAR_10_wrapper_FC_1u_64u_10u_Pipeline_VITIS_LOOP_149_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] i_fu_30;
wire   [31:0] i_23_fu_68_p2;
wire    ap_loop_init;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] ap_sig_allocacmp_i_22;
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_i_22 = 32'd0;
    end else begin
        ap_sig_allocacmp_i_22 = i_fu_30;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_11_full_n == 1'b0) | (connect_10_empty_n == 1'b0));
end
...
assign i_23_fu_68_p2 = (ap_sig_allocacmp_i_22 + 32'd1);

assign icmp_ln149_fu_62_p2 = ((ap_sig_allocacmp_i_22 == KER_bound) ? 1'b1 : 1'b0);

endmodule //CIFAR_10_wrapper_FC_1u_64u_10u_Pipeline_VITIS_LOOP_149_7
