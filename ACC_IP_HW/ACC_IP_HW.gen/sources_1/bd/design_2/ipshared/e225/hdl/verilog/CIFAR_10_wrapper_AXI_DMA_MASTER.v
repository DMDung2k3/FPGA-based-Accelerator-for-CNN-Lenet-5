...
module CIFAR_10_wrapper_AXI_DMA_MASTER (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [31:0] connect_11_dout;
input  [6:0] connect_11_num_data_valid;
input  [6:0] connect_11_fifo_cap;
input   connect_11_empty_n;
output   connect_11_read;
...
reg  signed [31:0] valIn_52_reg_178;
reg    ap_block_state2;
wire   [63:0] zext_ln18_fu_98_p1;
reg  signed [31:0] valIn_53_reg_188;
reg    ap_block_state3;
wire   [63:0] zext_ln23_fu_103_p1;
reg  signed [31:0] valIn_54_reg_199;
reg    ap_block_state4;
wire   [63:0] zext_ln28_fu_108_p1;
wire   [63:0] zext_ln33_fu_113_p1;
reg    ap_block_state5;
reg  signed [31:0] valIn_56_reg_214;
reg    ap_block_state6;
wire   [63:0] zext_ln38_fu_118_p1;
reg  signed [31:0] valIn_57_reg_225;
reg    ap_block_state7;
...
wire    grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_74_2_fu_67_connect_11_read;
...
wire    grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_58_1_fu_77_connect_11_read;
...
CIFAR_10_wrapper_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_74_2 grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_74_2_fu_67(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .connect_11_read(grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_74_2_fu_67_connect_11_read),
...
CIFAR_10_wrapper_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_58_1 grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_58_1_fu_77(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .connect_11_fifo_cap(7'd0),
    .connect_11_empty_n(connect_11_empty_n),
    .connect_11_read(grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_58_1_fu_77_connect_11_read),
...
CIFAR_10_wrapper_mul_32s_32s_32_1_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
mul_32s_32s_32_1_1_U1400(
    .din0(valIn_56_reg_214),
    .din1(valIn_53_reg_188),
...
CIFAR_10_wrapper_mul_32s_32s_32_1_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
mul_32s_32s_32_1_1_U1401(
    .din0(valIn_57_reg_225),
    .din1(valIn_56_reg_214),
...
CIFAR_10_wrapper_mul_32s_32s_32_1_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
mul_32s_32s_32_1_1_U1402(
    .din0(valIn_53_reg_188),
...
CIFAR_10_wrapper_mul_32s_32s_32_1_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
mul_32s_32s_32_1_1_U1403(
    .din0(valIn_54_reg_199),
...
CIFAR_10_wrapper_mul_32s_32s_32_1_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
mul_32s_32s_32_1_1_U1405(
    .din0(valIn_52_reg_178),
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1)))) begin
        connect_11_blk_n = connect_11_empty_n;
    end else begin
...
always @ (*) begin
    if (((~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state8)) & (1'b1 == ap_CS_fsm_state8)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state7)) & (1'b1 == ap_CS_fsm_state7)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state6)) & (1'b1 == ap_CS_fsm_state6)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state5)) & (1'b1 == ap_CS_fsm_state5)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state4)) & (1'b1 == ap_CS_fsm_state4)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state3)) & (1'b1 == ap_CS_fsm_state3)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state2)) & (1'b1 == ap_CS_fsm_state2)) | (~((out_stream_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        connect_11_read = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state17)) begin
        connect_11_read = grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_58_1_fu_77_connect_11_read;
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        connect_11_read = grp_AXI_DMA_MASTER_Pipeline_VITIS_LOOP_74_2_fu_67_connect_11_read;
    end else begin
        connect_11_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end

always @ (*) begin
    ap_block_state2 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state3 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state5 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state6 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state7 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state8 = ((connect_11_empty_n == 1'b0) | (out_stream_TREADY_int_regslice == 1'b0));
end
...
assign icmp_ln50_fu_92_p2 = ((connect_11_dout == 32'd0) ? 1'b1 : 1'b0);
...
assign zext_ln13_fu_87_p1 = connect_11_dout;

assign zext_ln18_fu_98_p0 = connect_11_dout;

assign zext_ln18_fu_98_p1 = $unsigned(zext_ln18_fu_98_p0);

assign zext_ln23_fu_103_p0 = connect_11_dout;

assign zext_ln23_fu_103_p1 = $unsigned(zext_ln23_fu_103_p0);

assign zext_ln28_fu_108_p0 = connect_11_dout;

assign zext_ln28_fu_108_p1 = $unsigned(zext_ln28_fu_108_p0);

assign zext_ln33_fu_113_p1 = connect_11_dout;

assign zext_ln38_fu_118_p0 = connect_11_dout;

assign zext_ln38_fu_118_p1 = $unsigned(zext_ln38_fu_118_p0);

assign zext_ln43_fu_123_p0 = connect_11_dout;

assign zext_ln43_fu_123_p1 = $unsigned(zext_ln43_fu_123_p0);

assign zext_ln48_fu_128_p1 = connect_11_dout;

endmodule //CIFAR_10_wrapper_AXI_DMA_MASTER
