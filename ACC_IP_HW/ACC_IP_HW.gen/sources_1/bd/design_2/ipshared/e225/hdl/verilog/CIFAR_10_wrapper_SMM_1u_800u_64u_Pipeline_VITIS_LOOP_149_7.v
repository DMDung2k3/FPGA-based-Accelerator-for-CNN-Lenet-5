...
module CIFAR_10_wrapper_SMM_1u_800u_64u_Pipeline_VITIS_LOOP_149_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_8_full_n == 1'b0) | (connect_7_empty_n == 1'b0));
end
...
assign i_8_fu_68_p2 = (ap_sig_allocacmp_i_7 + 32'd1);

assign icmp_ln149_fu_62_p2 = ((ap_sig_allocacmp_i_7 == KER_bound) ? 1'b1 : 1'b0);

endmodule //CIFAR_10_wrapper_SMM_1u_800u_64u_Pipeline_VITIS_LOOP_149_7
