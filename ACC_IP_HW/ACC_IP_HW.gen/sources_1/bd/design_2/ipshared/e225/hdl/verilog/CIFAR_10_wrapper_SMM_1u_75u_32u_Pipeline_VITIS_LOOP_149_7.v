...
module CIFAR_10_wrapper_SMM_1u_75u_32u_Pipeline_VITIS_LOOP_149_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_2_full_n == 1'b0) | (connect_1_empty_n == 1'b0));
end
...
assign i_12_fu_68_p2 = (ap_sig_allocacmp_i_11 + 32'd1);

assign icmp_ln149_fu_62_p2 = ((ap_sig_allocacmp_i_11 == KER_bound) ? 1'b1 : 1'b0);

endmodule //CIFAR_10_wrapper_SMM_1u_75u_32u_Pipeline_VITIS_LOOP_149_7
