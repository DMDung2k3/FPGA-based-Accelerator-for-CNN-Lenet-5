...
module CIFAR_10_wrapper_SCIG_5u_3u_32u_32u_32u_2u_Pipeline_VITIS_LOOP_189_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln189_fu_62_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_10_fu_30 <= i_13_fu_68_p2;
...
always @ (*) begin
    if (((icmp_ln189_fu_62_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_1_full_n == 1'b0) | (connect_0_empty_n == 1'b0));
end
...
assign connect_1_din = connect_0_dout;

assign i_13_fu_68_p2 = (ap_sig_allocacmp_i + 32'd1);

assign icmp_ln189_fu_62_p2 = ((ap_sig_allocacmp_i == KER_bound) ? 1'b1 : 1'b0);

endmodule //CIFAR_10_wrapper_SCIG_5u_3u_32u_32u_32u_2u_Pipeline_VITIS_LOOP_189_6
