...
(* CORE_GENERATION_INFO="CIFAR_10_wrapper_CIFAR_10_wrapper,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=12.592000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=249,HLS_SYN_DSP=0,HLS_SYN_FF=39188,HLS_SYN_LUT=140357,HLS_VERSION=2023_2}" *)

module CIFAR_10_wrapper (
        in_stream_TDATA,
        out_stream_TDATA,
        ap_clk,
        ap_rst_n,
...
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_ap_start;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_ap_done;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_ap_continue;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_ap_idle;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_ap_ready;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_start_out;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_start_write;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_connect_0_read;
wire   [31:0] SCIG_5u_3u_32u_32u_32u_2u_U0_connect_1_din;
wire    SCIG_5u_3u_32u_32u_32u_2u_U0_connect_1_write;
...
wire    SMM_1u_75u_32u_U0_connect_1_read;
wire   [31:0] SMM_1u_75u_32u_U0_connect_2_din;
wire    SMM_1u_75u_32u_U0_connect_2_write;
...
wire    pool_2u_32u_32u_U0_connect_2_read;
wire   [31:0] pool_2u_32u_32u_U0_connect_3_din;
wire    pool_2u_32u_32u_U0_connect_3_write;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_ap_start;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_ap_done;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_ap_continue;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_ap_idle;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_ap_ready;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_start_out;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_start_write;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_connect_3_read;
wire   [31:0] SCIG_5u_32u_16u_32u_16u_2u_U0_connect_4_din;
wire    SCIG_5u_32u_16u_32u_16u_2u_U0_connect_4_write;
...
wire    SMM_1u_800u_32u_U0_connect_4_read;
wire   [31:0] SMM_1u_800u_32u_U0_connect_5_din;
wire    SMM_1u_800u_32u_U0_connect_5_write;
...
wire    pool_2u_32u_16u_U0_connect_5_read;
wire   [31:0] pool_2u_32u_16u_U0_connect_6_din;
wire    pool_2u_32u_16u_U0_connect_6_write;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_ap_start;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_ap_done;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_ap_continue;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_ap_idle;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_ap_ready;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_start_out;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_start_write;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_connect_6_read;
wire   [31:0] SCIG_5u_32u_8u_64u_8u_2u_U0_connect_7_din;
wire    SCIG_5u_32u_8u_64u_8u_2u_U0_connect_7_write;
...
wire    SMM_1u_800u_64u_U0_connect_7_read;
wire   [31:0] SMM_1u_800u_64u_U0_connect_8_din;
wire    SMM_1u_800u_64u_U0_connect_8_write;
...
wire    pool_2u_64u_8u_U0_connect_8_read;
wire   [31:0] pool_2u_64u_8u_U0_connect_9_din;
wire    pool_2u_64u_8u_U0_connect_9_write;
...
wire    FC_1u_1024u_64u_U0_connect_9_read;
wire   [31:0] FC_1u_1024u_64u_U0_connect_10_din;
wire    FC_1u_1024u_64u_U0_connect_10_write;
...
wire    FC_1u_64u_10u_U0_connect_10_read;
wire   [31:0] FC_1u_64u_10u_U0_connect_11_din;
wire    FC_1u_64u_10u_U0_connect_11_write;
...
wire    AXI_DMA_MASTER_U0_connect_11_read;
...
wire   [2:0] connect_8_num_data_valid;
wire   [2:0] connect_8_fifo_cap;
wire    connect_8_empty_n;
wire    connect_9_full_n;
wire   [31:0] connect_9_dout;
wire   [6:0] connect_9_num_data_valid;
wire   [6:0] connect_9_fifo_cap;
wire    connect_9_empty_n;
wire    connect_10_full_n;
wire   [31:0] connect_10_dout;
wire   [6:0] connect_10_num_data_valid;
wire   [6:0] connect_10_fifo_cap;
wire    connect_10_empty_n;
wire    connect_11_full_n;
wire   [31:0] connect_11_dout;
wire   [6:0] connect_11_num_data_valid;
wire   [6:0] connect_11_fifo_cap;
wire    connect_11_empty_n;
wire   [0:0] start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_din;
wire    start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_full_n;
wire   [0:0] start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_dout;
wire    start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_empty_n;
...
wire   [0:0] start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_din;
wire    start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_full_n;
wire   [0:0] start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_dout;
wire    start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_empty_n;
...
wire   [0:0] start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_din;
wire    start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_full_n;
wire   [0:0] start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_dout;
wire    start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_empty_n;
...
CIFAR_10_wrapper_AXI_DMA_SLAVE AXI_DMA_SLAVE_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(AXI_DMA_SLAVE_U0_ap_start),
    .start_full_n(start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_full_n),
...
CIFAR_10_wrapper_SCIG_5u_3u_32u_32u_32u_2u_s SCIG_5u_3u_32u_32u_32u_2u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(SCIG_5u_3u_32u_32u_32u_2u_U0_ap_start),
    .start_full_n(start_for_SMM_1u_75u_32u_U0_full_n),
    .ap_done(SCIG_5u_3u_32u_32u_32u_2u_U0_ap_done),
    .ap_continue(SCIG_5u_3u_32u_32u_32u_2u_U0_ap_continue),
    .ap_idle(SCIG_5u_3u_32u_32u_32u_2u_U0_ap_idle),
    .ap_ready(SCIG_5u_3u_32u_32u_32u_2u_U0_ap_ready),
    .start_out(SCIG_5u_3u_32u_32u_32u_2u_U0_start_out),
    .start_write(SCIG_5u_3u_32u_32u_32u_2u_U0_start_write),
    .connect_0_dout(connect_0_dout),
    .connect_0_num_data_valid(connect_0_num_data_valid),
    .connect_0_fifo_cap(connect_0_fifo_cap),
    .connect_0_empty_n(connect_0_empty_n),
    .connect_0_read(SCIG_5u_3u_32u_32u_32u_2u_U0_connect_0_read),
    .connect_1_din(SCIG_5u_3u_32u_32u_32u_2u_U0_connect_1_din),
    .connect_1_num_data_valid(connect_1_num_data_valid),
    .connect_1_fifo_cap(connect_1_fifo_cap),
    .connect_1_full_n(connect_1_full_n),
    .connect_1_write(SCIG_5u_3u_32u_32u_32u_2u_U0_connect_1_write)
);

CIFAR_10_wrapper_SMM_1u_75u_32u_s SMM_1u_75u_32u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_1_read(SMM_1u_75u_32u_U0_connect_1_read),
    .connect_2_din(SMM_1u_75u_32u_U0_connect_2_din),
    .connect_2_num_data_valid(connect_2_num_data_valid),
    .connect_2_fifo_cap(connect_2_fifo_cap),
    .connect_2_full_n(connect_2_full_n),
    .connect_2_write(SMM_1u_75u_32u_U0_connect_2_write)
);

CIFAR_10_wrapper_pool_2u_32u_32u_s pool_2u_32u_32u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(pool_2u_32u_32u_U0_ap_start),
    .start_full_n(start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_full_n),
    ...
    .connect_2_read(pool_2u_32u_32u_U0_connect_2_read),
    .connect_3_din(pool_2u_32u_32u_U0_connect_3_din),
    .connect_3_num_data_valid(connect_3_num_data_valid),
    .connect_3_fifo_cap(connect_3_fifo_cap),
    .connect_3_full_n(connect_3_full_n),
    .connect_3_write(pool_2u_32u_32u_U0_connect_3_write)
);

CIFAR_10_wrapper_SCIG_5u_32u_16u_32u_16u_2u_s SCIG_5u_32u_16u_32u_16u_2u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(SCIG_5u_32u_16u_32u_16u_2u_U0_ap_start),
    .start_full_n(start_for_SMM_1u_800u_32u_U0_full_n),
    .ap_done(SCIG_5u_32u_16u_32u_16u_2u_U0_ap_done),
    .ap_continue(SCIG_5u_32u_16u_32u_16u_2u_U0_ap_continue),
    .ap_idle(SCIG_5u_32u_16u_32u_16u_2u_U0_ap_idle),
    .ap_ready(SCIG_5u_32u_16u_32u_16u_2u_U0_ap_ready),
    .start_out(SCIG_5u_32u_16u_32u_16u_2u_U0_start_out),
    .start_write(SCIG_5u_32u_16u_32u_16u_2u_U0_start_write),
    .connect_3_dout(connect_3_dout),
    .connect_3_num_data_valid(connect_3_num_data_valid),
    .connect_3_fifo_cap(connect_3_fifo_cap),
    .connect_3_empty_n(connect_3_empty_n),
    .connect_3_read(SCIG_5u_32u_16u_32u_16u_2u_U0_connect_3_read),
    .connect_4_din(SCIG_5u_32u_16u_32u_16u_2u_U0_connect_4_din),
    .connect_4_num_data_valid(connect_4_num_data_valid),
    .connect_4_fifo_cap(connect_4_fifo_cap),
    .connect_4_full_n(connect_4_full_n),
    .connect_4_write(SCIG_5u_32u_16u_32u_16u_2u_U0_connect_4_write)
);

CIFAR_10_wrapper_SMM_1u_800u_32u_s SMM_1u_800u_32u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_4_read(SMM_1u_800u_32u_U0_connect_4_read),
    .connect_5_din(SMM_1u_800u_32u_U0_connect_5_din),
    .connect_5_num_data_valid(connect_5_num_data_valid),
    .connect_5_fifo_cap(connect_5_fifo_cap),
    .connect_5_full_n(connect_5_full_n),
    .connect_5_write(SMM_1u_800u_32u_U0_connect_5_write)
);

CIFAR_10_wrapper_pool_2u_32u_16u_s pool_2u_32u_16u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(pool_2u_32u_16u_U0_ap_start),
    .start_full_n(start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_full_n),
    ...
    .connect_5_read(pool_2u_32u_16u_U0_connect_5_read),
    .connect_6_din(pool_2u_32u_16u_U0_connect_6_din),
    .connect_6_num_data_valid(connect_6_num_data_valid),
    .connect_6_fifo_cap(connect_6_fifo_cap),
    .connect_6_full_n(connect_6_full_n),
    .connect_6_write(pool_2u_32u_16u_U0_connect_6_write)
);

CIFAR_10_wrapper_SCIG_5u_32u_8u_64u_8u_2u_s SCIG_5u_32u_8u_64u_8u_2u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(SCIG_5u_32u_8u_64u_8u_2u_U0_ap_start),
    .start_full_n(start_for_SMM_1u_800u_64u_U0_full_n),
    .ap_done(SCIG_5u_32u_8u_64u_8u_2u_U0_ap_done),
    .ap_continue(SCIG_5u_32u_8u_64u_8u_2u_U0_ap_continue),
    .ap_idle(SCIG_5u_32u_8u_64u_8u_2u_U0_ap_idle),
    .ap_ready(SCIG_5u_32u_8u_64u_8u_2u_U0_ap_ready),
    .start_out(SCIG_5u_32u_8u_64u_8u_2u_U0_start_out),
    .start_write(SCIG_5u_32u_8u_64u_8u_2u_U0_start_write),
    .connect_6_dout(connect_6_dout),
    .connect_6_num_data_valid(connect_6_num_data_valid),
    .connect_6_fifo_cap(connect_6_fifo_cap),
    .connect_6_empty_n(connect_6_empty_n),
    .connect_6_read(SCIG_5u_32u_8u_64u_8u_2u_U0_connect_6_read),
    .connect_7_din(SCIG_5u_32u_8u_64u_8u_2u_U0_connect_7_din),
    .connect_7_num_data_valid(connect_7_num_data_valid),
    .connect_7_fifo_cap(connect_7_fifo_cap),
    .connect_7_full_n(connect_7_full_n),
    .connect_7_write(SCIG_5u_32u_8u_64u_8u_2u_U0_connect_7_write)
);

CIFAR_10_wrapper_SMM_1u_800u_64u_s SMM_1u_800u_64u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_7_read(SMM_1u_800u_64u_U0_connect_7_read),
    .connect_8_din(SMM_1u_800u_64u_U0_connect_8_din),
    .connect_8_num_data_valid(connect_8_num_data_valid),
    .connect_8_fifo_cap(connect_8_fifo_cap),
    .connect_8_full_n(connect_8_full_n),
    .connect_8_write(SMM_1u_800u_64u_U0_connect_8_write)
);

CIFAR_10_wrapper_pool_2u_64u_8u_s pool_2u_64u_8u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_8_read(pool_2u_64u_8u_U0_connect_8_read),
    .connect_9_din(pool_2u_64u_8u_U0_connect_9_din),
    .connect_9_num_data_valid(connect_9_num_data_valid),
    .connect_9_fifo_cap(connect_9_fifo_cap),
    .connect_9_full_n(connect_9_full_n),
    .connect_9_write(pool_2u_64u_8u_U0_connect_9_write)
);

CIFAR_10_wrapper_FC_1u_1024u_64u_s FC_1u_1024u_64u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_9_read(FC_1u_1024u_64u_U0_connect_9_read),
    .connect_10_din(FC_1u_1024u_64u_U0_connect_10_din),
    .connect_10_num_data_valid(connect_10_num_data_valid),
    .connect_10_fifo_cap(connect_10_fifo_cap),
    .connect_10_full_n(connect_10_full_n),
    .connect_10_write(FC_1u_1024u_64u_U0_connect_10_write)
);

CIFAR_10_wrapper_FC_1u_64u_10u_s FC_1u_64u_10u_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_10_read(FC_1u_64u_10u_U0_connect_10_read),
    .connect_11_din(FC_1u_64u_10u_U0_connect_11_din),
    .connect_11_num_data_valid(connect_11_num_data_valid),
    .connect_11_fifo_cap(connect_11_fifo_cap),
    .connect_11_full_n(connect_11_full_n),
    .connect_11_write(FC_1u_64u_10u_U0_connect_11_write)
);

CIFAR_10_wrapper_AXI_DMA_MASTER AXI_DMA_MASTER_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .connect_11_dout(connect_11_dout),
    .connect_11_num_data_valid(connect_11_num_data_valid),
    .connect_11_fifo_cap(connect_11_fifo_cap),
    .connect_11_empty_n(connect_11_empty_n),
    .connect_11_read(AXI_DMA_MASTER_U0_connect_11_read),
    .out_stream_TDATA(AXI_DMA_MASTER_U0_out_stream_TDATA),
    .out_stream_TVALID(AXI_DMA_MASTER_U0_out_stream_TVALID),
    .out_stream_TREADY(out_stream_TREADY)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(SCIG_5u_3u_32u_32u_32u_2u_U0_connect_0_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SCIG_5u_3u_32u_32u_32u_2u_U0_connect_1_din),
    .if_full_n(connect_1_full_n),
    .if_write(SCIG_5u_3u_32u_32u_32u_2u_U0_connect_1_write),
    ...
    .if_read(SMM_1u_75u_32u_U0_connect_1_read)
);

CIFAR_10_wrapper_fifo_w32_d2_S connect_2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SMM_1u_75u_32u_U0_connect_2_din),
    .if_full_n(connect_2_full_n),
    .if_write(SMM_1u_75u_32u_U0_connect_2_write),
    ...
    .if_read(pool_2u_32u_32u_U0_connect_2_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_3_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(pool_2u_32u_32u_U0_connect_3_din),
    .if_full_n(connect_3_full_n),
    .if_write(pool_2u_32u_32u_U0_connect_3_write),
    ...
    .if_read(SCIG_5u_32u_16u_32u_16u_2u_U0_connect_3_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_4_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SCIG_5u_32u_16u_32u_16u_2u_U0_connect_4_din),
    .if_full_n(connect_4_full_n),
    .if_write(SCIG_5u_32u_16u_32u_16u_2u_U0_connect_4_write),
    ...
    .if_read(SMM_1u_800u_32u_U0_connect_4_read)
);

CIFAR_10_wrapper_fifo_w32_d2_S connect_5_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SMM_1u_800u_32u_U0_connect_5_din),
    .if_full_n(connect_5_full_n),
    .if_write(SMM_1u_800u_32u_U0_connect_5_write),
    ...
    .if_read(pool_2u_32u_16u_U0_connect_5_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_6_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(pool_2u_32u_16u_U0_connect_6_din),
    .if_full_n(connect_6_full_n),
    .if_write(pool_2u_32u_16u_U0_connect_6_write),
    ...
    .if_read(SCIG_5u_32u_8u_64u_8u_2u_U0_connect_6_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_7_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SCIG_5u_32u_8u_64u_8u_2u_U0_connect_7_din),
    .if_full_n(connect_7_full_n),
    .if_write(SCIG_5u_32u_8u_64u_8u_2u_U0_connect_7_write),
    ...
    .if_read(SMM_1u_800u_64u_U0_connect_7_read)
);

CIFAR_10_wrapper_fifo_w32_d2_S connect_8_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SMM_1u_800u_64u_U0_connect_8_din),
    .if_full_n(connect_8_full_n),
    .if_write(SMM_1u_800u_64u_U0_connect_8_write),
    ...
    .if_read(pool_2u_64u_8u_U0_connect_8_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_9_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(pool_2u_64u_8u_U0_connect_9_din),
    .if_full_n(connect_9_full_n),
    .if_write(pool_2u_64u_8u_U0_connect_9_write),
    .if_dout(connect_9_dout),
    .if_num_data_valid(connect_9_num_data_valid),
    .if_fifo_cap(connect_9_fifo_cap),
    .if_empty_n(connect_9_empty_n),
    .if_read(FC_1u_1024u_64u_U0_connect_9_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_10_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(FC_1u_1024u_64u_U0_connect_10_din),
    .if_full_n(connect_10_full_n),
    .if_write(FC_1u_1024u_64u_U0_connect_10_write),
    .if_dout(connect_10_dout),
    .if_num_data_valid(connect_10_num_data_valid),
    .if_fifo_cap(connect_10_fifo_cap),
    .if_empty_n(connect_10_empty_n),
    .if_read(FC_1u_64u_10u_U0_connect_10_read)
);

CIFAR_10_wrapper_fifo_w32_d50_A connect_11_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(FC_1u_64u_10u_U0_connect_11_din),
    .if_full_n(connect_11_full_n),
    .if_write(FC_1u_64u_10u_U0_connect_11_write),
    .if_dout(connect_11_dout),
    .if_num_data_valid(connect_11_num_data_valid),
    .if_fifo_cap(connect_11_fifo_cap),
    .if_empty_n(connect_11_empty_n),
    .if_read(AXI_DMA_MASTER_U0_connect_11_read)
);

CIFAR_10_wrapper_start_for_SCIG_5u_3u_32u_32u_32u_2u_U0 start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_din),
    .if_full_n(start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_full_n),
    .if_write(AXI_DMA_SLAVE_U0_start_write),
    .if_dout(start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_dout),
    .if_empty_n(start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_empty_n),
    .if_read(SCIG_5u_3u_32u_32u_32u_2u_U0_ap_ready)
);

CIFAR_10_wrapper_start_for_SMM_1u_75u_32u_U0 start_for_SMM_1u_75u_32u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(SCIG_5u_3u_32u_32u_32u_2u_U0_start_write),
    .if_dout(start_for_SMM_1u_75u_32u_U0_dout),
    .if_empty_n(start_for_SMM_1u_75u_32u_U0_empty_n),
    .if_read(SMM_1u_75u_32u_U0_ap_ready)
);

CIFAR_10_wrapper_start_for_pool_2u_32u_32u_U0 start_for_pool_2u_32u_32u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
CIFAR_10_wrapper_start_for_SCIG_5u_32u_16u_32u_16u_2u_U0 start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_din),
    .if_full_n(start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_full_n),
    .if_write(pool_2u_32u_32u_U0_start_write),
    .if_dout(start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_dout),
    .if_empty_n(start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_empty_n),
    .if_read(SCIG_5u_32u_16u_32u_16u_2u_U0_ap_ready)
);

CIFAR_10_wrapper_start_for_SMM_1u_800u_32u_U0 start_for_SMM_1u_800u_32u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(SCIG_5u_32u_16u_32u_16u_2u_U0_start_write),
...
CIFAR_10_wrapper_start_for_pool_2u_32u_16u_U0 start_for_pool_2u_32u_16u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
CIFAR_10_wrapper_start_for_SCIG_5u_32u_8u_64u_8u_2u_U0 start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_din),
    .if_full_n(start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_full_n),
    .if_write(pool_2u_32u_16u_U0_start_write),
    .if_dout(start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_dout),
    .if_empty_n(start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_empty_n),
    .if_read(SCIG_5u_32u_8u_64u_8u_2u_U0_ap_ready)
);

CIFAR_10_wrapper_start_for_SMM_1u_800u_64u_U0 start_for_SMM_1u_800u_64u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_write(SCIG_5u_32u_8u_64u_8u_2u_U0_start_write),
...
CIFAR_10_wrapper_start_for_pool_2u_64u_8u_U0 start_for_pool_2u_64u_8u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
CIFAR_10_wrapper_start_for_FC_1u_1024u_64u_U0 start_for_FC_1u_1024u_64u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
CIFAR_10_wrapper_start_for_FC_1u_64u_10u_U0 start_for_FC_1u_64u_10u_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
CIFAR_10_wrapper_start_for_AXI_DMA_MASTER_U0 start_for_AXI_DMA_MASTER_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign SCIG_5u_32u_16u_32u_16u_2u_U0_ap_continue = 1'b1;

assign SCIG_5u_32u_16u_32u_16u_2u_U0_ap_start = start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_empty_n;

assign SCIG_5u_32u_8u_64u_8u_2u_U0_ap_continue = 1'b1;

assign SCIG_5u_32u_8u_64u_8u_2u_U0_ap_start = start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_empty_n;

assign SCIG_5u_3u_32u_32u_32u_2u_U0_ap_continue = 1'b1;

assign SCIG_5u_3u_32u_32u_32u_2u_U0_ap_start = start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_empty_n;
...
assign start_for_SCIG_5u_32u_16u_32u_16u_2u_U0_din = 1'b1;

assign start_for_SCIG_5u_32u_8u_64u_8u_2u_U0_din = 1'b1;

assign start_for_SCIG_5u_3u_32u_32u_32u_2u_U0_din = 1'b1;
...
`include "CIFAR_10_wrapper_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "CIFAR_10_wrapper_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //CIFAR_10_wrapper
