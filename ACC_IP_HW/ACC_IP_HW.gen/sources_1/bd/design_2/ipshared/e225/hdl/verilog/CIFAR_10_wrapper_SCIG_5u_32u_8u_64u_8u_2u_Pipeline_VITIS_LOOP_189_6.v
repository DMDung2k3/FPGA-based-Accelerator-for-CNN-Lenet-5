...
module CIFAR_10_wrapper_SCIG_5u_32u_8u_64u_8u_2u_Pipeline_VITIS_LOOP_189_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_7_full_n == 1'b0) | (connect_6_empty_n == 1'b0));
end
...
assign i_16_fu_68_p2 = (ap_sig_allocacmp_i + 32'd1);

assign icmp_ln189_fu_62_p2 = ((ap_sig_allocacmp_i == KER_bound) ? 1'b1 : 1'b0);

endmodule //CIFAR_10_wrapper_SCIG_5u_32u_8u_64u_8u_2u_Pipeline_VITIS_LOOP_189_6
