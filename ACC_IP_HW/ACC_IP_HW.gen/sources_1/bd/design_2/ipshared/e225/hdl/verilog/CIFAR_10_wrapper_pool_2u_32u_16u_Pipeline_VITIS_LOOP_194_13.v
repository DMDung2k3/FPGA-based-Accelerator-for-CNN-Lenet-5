...
module CIFAR_10_wrapper_pool_2u_32u_16u_Pipeline_VITIS_LOOP_194_13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_6_full_n == 1'b0) | (connect_5_empty_n == 1'b0));
end
...
assign connect_6_din = connect_5_dout;

assign i_6_fu_68_p2 = (ap_sig_allocacmp_i_5 + 32'd1);

assign icmp_ln194_fu_62_p2 = ((ap_sig_allocacmp_i_5 == KER_bound) ? 1'b1 : 1'b0);

endmodule //CIFAR_10_wrapper_pool_2u_32u_16u_Pipeline_VITIS_LOOP_194_13
