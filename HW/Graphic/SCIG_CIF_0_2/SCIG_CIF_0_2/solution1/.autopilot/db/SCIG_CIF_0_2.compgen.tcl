...
set name SCIG_CIF_0_2_mul_32s_14ns_32_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name SCIG_CIF_0_2_mul_32s_32s_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler SCIG_CIF_0_2_inElem_RAM_S2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_s2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_padValue \
    op interface \
    ports { padValue { I 32 vector } } \
} "
}
...
# RegSlice definition:
set ID 20
set RegSliceName SCIG_CIF_0_2_regslice_both
set RegSliceInstName SCIG_CIF_0_2_regslice_both_U
set CoreName ap_simcore_SCIG_CIF_0_2_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
