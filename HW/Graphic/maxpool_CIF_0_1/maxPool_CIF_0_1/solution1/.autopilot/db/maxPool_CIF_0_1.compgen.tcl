...
set name maxPool_CIF_0_1_mul_31ns_32ns_63_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name maxPool_CIF_0_1_mul_32ns_31ns_63_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name maxPool_CIF_0_1_mul_32s_32s_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxPool_CIF_0_1_buf_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxPool_CIF_0_1_acc_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
...
# RegSlice definition:
set ID 81
set RegSliceName maxPool_CIF_0_1_regslice_both
set RegSliceInstName maxPool_CIF_0_1_regslice_both_U
set CoreName ap_simcore_maxPool_CIF_0_1_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
