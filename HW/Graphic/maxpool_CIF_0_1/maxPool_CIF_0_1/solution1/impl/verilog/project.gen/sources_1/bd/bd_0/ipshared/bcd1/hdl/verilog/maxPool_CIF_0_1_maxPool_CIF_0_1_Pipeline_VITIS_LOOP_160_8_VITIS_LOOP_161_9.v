...
module maxPool_CIF_0_1_maxPool_CIF_0_1_Pipeline_VITIS_LOOP_160_8_VITIS_LOOP_161_9 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] valIn_data_fu_162_p1;
reg   [31:0] valIn_data_reg_265;
reg   [4:0] acc_addr_reg_271;
...
wire   [31:0] select_ln165_fu_211_p3;
reg   [5:0] ch_1_fu_60;
wire   [5:0] add_ln161_fu_180_p2;
reg   [32:0] indvar_flatten_fu_64;
wire   [32:0] add_ln160_fu_143_p2;
wire   [31:0] zext_ln161_1_fu_129_p1;
wire   [0:0] icmp_ln161_fu_133_p2;
wire   [5:0] select_ln160_fu_149_p3;
wire   [31:0] reuse_select_fu_199_p3;
wire   [0:0] icmp_ln165_fu_206_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        acc_addr_reg_271 <= zext_ln161_fu_157_p1;
...
assign acc_address1 = acc_addr_reg_271;

assign acc_d1 = ((icmp_ln165_fu_206_p2[0:0] == 1'b1) ? reuse_select_fu_199_p3 : valIn_data_reg_265);

assign add_ln160_fu_143_p2 = (indvar_flatten_fu_64 + 33'd1);

assign add_ln161_fu_180_p2 = (select_ln160_fu_149_p3 + 6'd1);

assign addr_cmp_fu_169_p2 = ((reuse_addr_reg_fu_52 == zext_ln161_fu_157_p1) ? 1'b1 : 1'b0);
...
assign icmp_ln165_fu_206_p2 = (($signed(reuse_select_fu_199_p3) > $signed(valIn_data_reg_265)) ? 1'b1 : 1'b0);

assign reuse_select_fu_199_p3 = ((addr_cmp_reg_277[0:0] == 1'b1) ? reuse_reg_fu_56 : acc_q0);

assign select_ln160_fu_149_p3 = ((icmp_ln161_fu_133_p2[0:0] == 1'b1) ? 6'd0 : ch_1_fu_60);

assign select_ln165_fu_211_p3 = ((icmp_ln165_fu_206_p2[0:0] == 1'b1) ? reuse_select_fu_199_p3 : valIn_data_reg_265);

assign valIn_data_fu_162_p1 = in_r_TDATA[31:0];

assign zext_ln161_1_fu_129_p1 = ch_1_fu_60;

assign zext_ln161_fu_157_p1 = select_ln160_fu_149_p3;

endmodule //maxPool_CIF_0_1_maxPool_CIF_0_1_Pipeline_VITIS_LOOP_160_8_VITIS_LOOP_161_9
