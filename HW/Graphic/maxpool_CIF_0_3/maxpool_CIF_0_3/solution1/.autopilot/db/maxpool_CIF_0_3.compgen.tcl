...
set name maxpool_CIF_0_3_mul_31ns_32ns_63_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name maxpool_CIF_0_3_mul_32ns_31ns_63_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name maxpool_CIF_0_3_mul_32s_32s_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxpool_CIF_0_3_buf_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxpool_CIF_0_3_acc_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
...
# RegSlice definition:
set ID 45
set RegSliceName maxpool_CIF_0_3_regslice_both
set RegSliceInstName maxpool_CIF_0_3_regslice_both_U
set CoreName ap_simcore_maxpool_CIF_0_3_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
