...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler maxpool_CIF_0_3_sparsemux_9_2_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename acc \
    op interface \
    ports { acc_address1 { O 6 vector } acc_ce1 { O 1 bit } acc_we1 { O 1 bit } acc_d1 { O 32 vector } acc_q1 { I 32 vector } } \
} "
} else {
