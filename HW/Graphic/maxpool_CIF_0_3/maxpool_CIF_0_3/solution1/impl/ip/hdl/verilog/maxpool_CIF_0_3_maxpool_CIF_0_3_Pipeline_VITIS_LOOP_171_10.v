...
module maxpool_CIF_0_3_maxpool_CIF_0_3_Pipeline_VITIS_LOOP_171_10 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] add_ln178_fu_211_p2;
reg   [31:0] add_ln178_reg_262;
wire   [63:0] zext_ln171_fu_174_p1;
wire    ap_block_pp0_stage0;
reg   [6:0] ch_fu_58;
wire   [6:0] add_ln171_fu_168_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln171_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        buf_1_addr_reg_239 <= zext_ln171_fu_174_p1;
        buf_1_addr_reg_239_pp0_iter1_reg <= buf_1_addr_reg_239;
        buf_2_addr_reg_245 <= zext_ln171_fu_174_p1;
        buf_2_addr_reg_245_pp0_iter1_reg <= buf_2_addr_reg_245;
        buf_3_addr_reg_251 <= zext_ln171_fu_174_p1;
        buf_3_addr_reg_251_pp0_iter1_reg <= buf_3_addr_reg_251;
        buf_addr_reg_233 <= zext_ln171_fu_174_p1;
        buf_addr_reg_233_pp0_iter1_reg <= buf_addr_reg_233;
    end
end

always @ (*) begin
    if (((icmp_ln171_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        acc_ce1 = 1'b1;
    end else begin
        acc_ce1 = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln171_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign acc_address1 = zext_ln171_fu_174_p1;

assign acc_d1 = 32'd0;

assign add_ln171_fu_168_p2 = (ap_sig_allocacmp_ch_1 + 7'd1);

assign add_ln178_fu_211_p2 = (acc_q1 + tmp_1_fu_188_p11);
...
assign buf_1_address0 = zext_ln171_fu_174_p1;

assign buf_1_address1 = buf_1_addr_reg_239_pp0_iter1_reg;

assign buf_1_d1 = add_ln178_reg_262;

assign buf_2_address0 = zext_ln171_fu_174_p1;

assign buf_2_address1 = buf_2_addr_reg_245_pp0_iter1_reg;

assign buf_2_d1 = add_ln178_reg_262;

assign buf_3_address0 = zext_ln171_fu_174_p1;

assign buf_3_address1 = buf_3_addr_reg_251_pp0_iter1_reg;

assign buf_3_d1 = add_ln178_reg_262;

assign buf_r_address0 = zext_ln171_fu_174_p1;

assign buf_r_address1 = buf_addr_reg_233_pp0_iter1_reg;

assign buf_r_d1 = add_ln178_reg_262;

assign icmp_ln171_fu_162_p2 = ((ap_sig_allocacmp_ch_1 == 7'd64) ? 1'b1 : 1'b0);

assign tmp_1_fu_188_p9 = 'bx;

assign tmp_reg_224 = empty;

assign zext_ln171_fu_174_p1 = ap_sig_allocacmp_ch_1;

endmodule //maxpool_CIF_0_3_maxpool_CIF_0_3_Pipeline_VITIS_LOOP_171_10
