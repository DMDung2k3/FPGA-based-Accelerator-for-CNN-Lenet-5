...
entity maxpool_CIF_0_3_maxpool_CIF_0_3_Pipeline_VITIS_LOOP_139_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of maxpool_CIF_0_3_maxpool_CIF_0_3_Pipeline_VITIS_LOOP_139_1 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln139_fu_138_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_fu_42 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln139_fu_132_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln139_fu_126_p2 = ap_const_lv1_0)) then 
                    j_fu_42 <= add_ln139_fu_132_p2;
    ...
    add_ln139_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_1) + unsigned(ap_const_lv7_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln139_fu_126_p2)
    begin
        if (((icmp_ln139_fu_126_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    buf_1_address1 <= zext_ln139_fu_138_p1(6 - 1 downto 0);
    ...
    buf_1_we1_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln139_fu_126_p2)
    begin
        if (((icmp_ln139_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    buf_2_address1 <= zext_ln139_fu_138_p1(6 - 1 downto 0);
    ...
    buf_2_we1_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln139_fu_126_p2)
    begin
        if (((icmp_ln139_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    buf_3_address1 <= zext_ln139_fu_138_p1(6 - 1 downto 0);
    ...
    buf_3_we1_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln139_fu_126_p2)
    begin
        if (((icmp_ln139_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    buf_r_address1 <= zext_ln139_fu_138_p1(6 - 1 downto 0);
    ...
    buf_r_we1_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln139_fu_126_p2)
    begin
        if (((icmp_ln139_fu_126_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    icmp_ln139_fu_126_p2 <= "1" when (ap_sig_allocacmp_j_1 = ap_const_lv7_40) else "0";
    zext_ln139_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_1),64));
end behav;
