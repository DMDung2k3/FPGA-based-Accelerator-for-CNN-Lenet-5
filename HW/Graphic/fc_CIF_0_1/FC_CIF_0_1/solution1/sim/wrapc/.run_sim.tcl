...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/downloads/.xinstall/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/downloads/.xinstall/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/downloads/.xinstall/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/downloads/.xinstall/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "FC_CIF_0_1.autotvin.dat"
	set constFileTvOut       "FC_CIF_0_1.autotvout.dat"
	set constFileHdlTvIn     "FC_CIF_0_1.autohdltvin.dat"
	set constFileHdlTvOut    "FC_CIF_0_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
