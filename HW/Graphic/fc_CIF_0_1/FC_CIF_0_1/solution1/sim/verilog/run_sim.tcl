...
if {[file isfile FC_CIF_0_1.autotvin.dat]} {
	file delete -force FC_CIF_0_1.autotvin.dat
}

if {[file isfile FC_CIF_0_1.autotvout.dat]} {
	file delete -force FC_CIF_0_1.autotvout.dat
}
