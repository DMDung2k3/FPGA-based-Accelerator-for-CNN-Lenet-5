...
module FC_CIF_0_1_hls_deadlock_idx0_monitor ( // for module FC_CIF_0_1_FC_CIF_0_1_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 FC_CIF_0_1_hls_deadlock_idx3_monitor FC_CIF_0_1_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 FC_CIF_0_1_hls_deadlock_idx4_monitor FC_CIF_0_1_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
