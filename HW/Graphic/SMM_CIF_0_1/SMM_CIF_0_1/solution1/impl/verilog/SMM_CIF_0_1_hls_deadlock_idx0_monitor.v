...
module SMM_CIF_0_1_hls_deadlock_idx0_monitor ( // for module SMM_CIF_0_1_SMM_CIF_0_1_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 SMM_CIF_0_1_hls_deadlock_idx3_monitor SMM_CIF_0_1_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 SMM_CIF_0_1_hls_deadlock_idx4_monitor SMM_CIF_0_1_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
