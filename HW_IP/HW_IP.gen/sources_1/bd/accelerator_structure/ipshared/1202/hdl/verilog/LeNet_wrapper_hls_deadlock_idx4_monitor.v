...
module LeNet_wrapper_hls_deadlock_idx4_monitor ( // for module LeNet_wrapper_LeNet_wrapper_inst.AXI_DMA_MASTER_U0
    input wire clock,
    input wire reset,
...
assign all_sub_single_has_block = 1'b0 | (idx6_block & (axis_block_sigs[5])) | (idx5_block & (axis_block_sigs[4]));
