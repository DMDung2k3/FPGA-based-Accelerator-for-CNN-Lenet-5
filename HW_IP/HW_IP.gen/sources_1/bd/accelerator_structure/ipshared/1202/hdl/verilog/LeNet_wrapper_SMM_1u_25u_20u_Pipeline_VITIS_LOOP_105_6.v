...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln105_reg_145;
reg   [0:0] icmp_ln108_reg_154;
...
reg   [4:0] A_addr_reg_149;
reg   [4:0] A_addr_reg_149_pp0_iter1_reg;
wire   [0:0] icmp_ln108_fu_123_p2;
wire   [7:0] trunc_ln110_fu_134_p1;
...
reg   [4:0] j_2_fu_50;
wire   [4:0] add_ln105_fu_108_p2;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_j;
wire   [31:0] zext_ln105_2_fu_119_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_105)) begin
        if (((icmp_ln108_fu_123_p2 == 1'd0) & (icmp_ln105_fu_102_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_107)) begin
        if (((icmp_ln108_reg_154 == 1'd1) & (icmp_ln105_reg_145 == 1'd0))) begin
            ap_phi_reg_pp0_iter2_storemerge_reg_82 <= trunc_ln110_fu_134_p1;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        A_addr_reg_149 <= zext_ln105_fu_114_p1;
        A_addr_reg_149_pp0_iter1_reg <= A_addr_reg_149;
        ap_loop_exit_ready_pp0_iter1_reg <= ap_loop_exit_ready;
        icmp_ln105_reg_145 <= icmp_ln105_fu_102_p2;
        icmp_ln108_reg_154 <= icmp_ln108_fu_123_p2;
    end
end
...
assign add_ln105_fu_108_p2 = (ap_sig_allocacmp_j + 5'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op25_read_state2 == 1'b1) & (connect_1_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_predicate_op25_read_state2 = ((icmp_ln108_reg_154 == 1'd1) & (icmp_ln105_reg_145 == 1'd0));
end

assign icmp_ln105_fu_102_p2 = ((ap_sig_allocacmp_j == 5'd25) ? 1'b1 : 1'b0);

assign icmp_ln108_fu_123_p2 = ((zext_ln105_2_fu_119_p1 < B_ROW_5_load) ? 1'b1 : 1'b0);

assign trunc_ln110_fu_134_p1 = connect_1_dout[7:0];

assign zext_ln105_2_fu_119_p1 = ap_sig_allocacmp_j;

assign zext_ln105_fu_114_p1 = ap_sig_allocacmp_j;
