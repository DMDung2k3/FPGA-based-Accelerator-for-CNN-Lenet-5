set moduleName pool_2u_50u_8u_Pipeline_VITIS_LOOP_144_8_VITIS_LOOP_145_9
set isTopModule 0
...
set C_modelName {pool<2u, 50u, 8u>_Pipeline_VITIS_LOOP_144_8_VITIS_LOOP_145_9}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln138 int 33 regular  }
	{ IFMCH_curr_load int 32 regular  }
	{ connect_5 int 32 regular {fifo 0 volatile }  }
	{ acc int 32 regular {array 50 { 1 0 } 1 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	...
	acc { ap_memory {  { acc_address0 mem_address 1 6 }  { acc_ce0 mem_ce 1 1 }  { acc_q0 in_data 0 32 }  { acc_address1 MemPortADDR2 1 6 }  { acc_ce1 MemPortCE2 1 1 }  { acc_we1 MemPortWE2 1 1 }  { acc_d1 MemPortDIN2 1 32 } } }
}
