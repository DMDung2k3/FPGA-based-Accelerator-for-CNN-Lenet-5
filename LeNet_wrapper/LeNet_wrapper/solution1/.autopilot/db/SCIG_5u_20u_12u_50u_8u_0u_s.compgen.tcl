...
set name LeNet_wrapper_mul_32s_12ns_32_2_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler LeNet_wrapper_SCIG_5u_20u_12u_50u_8u_0u_s_inElem_RAM_S2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_s2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
