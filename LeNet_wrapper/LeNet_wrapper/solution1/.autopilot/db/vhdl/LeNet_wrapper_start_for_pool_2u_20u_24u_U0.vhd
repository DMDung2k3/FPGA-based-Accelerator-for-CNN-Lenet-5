...
entity LeNet_wrapper_start_for_pool_2u_20u_24u_U0 is 
    generic (
...
architecture rtl of LeNet_wrapper_start_for_pool_2u_20u_24u_U0 is

    component LeNet_wrapper_start_for_pool_2u_20u_24u_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_LeNet_wrapper_start_for_pool_2u_20u_24u_U0_ShiftReg : LeNet_wrapper_start_for_pool_2u_20u_24u_U0_ShiftReg
    generic map (
...
entity LeNet_wrapper_start_for_pool_2u_20u_24u_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end LeNet_wrapper_start_for_pool_2u_20u_24u_U0_ShiftReg;

architecture rtl of LeNet_wrapper_start_for_pool_2u_20u_24u_U0_ShiftReg is
