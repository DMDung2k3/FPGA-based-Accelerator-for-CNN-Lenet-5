...
set id 346
set name LeNet_wrapper_mac_muladd_19s_10ns_10ns_19_4_1
...
set ce_signed 0
set out_width 19
set arg_lists {i0 {19 1 +} i1 {10 0 +} m {19 1 +} i2 {10 0 +} p {19 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set id 347
set name LeNet_wrapper_mac_muladd_8s_8s_16ns_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B \
    op interface \
    ports { B_address0 { O 19 vector } B_ce0 { O 1 bit } B_q0 { I 8 vector } } \
} "
} else {
