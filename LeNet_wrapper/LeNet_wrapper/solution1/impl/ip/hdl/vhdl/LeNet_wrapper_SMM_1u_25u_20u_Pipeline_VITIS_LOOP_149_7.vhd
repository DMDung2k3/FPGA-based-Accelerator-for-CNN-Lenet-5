...
entity LeNet_wrapper_SMM_1u_25u_20u_Pipeline_VITIS_LOOP_149_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of LeNet_wrapper_SMM_1u_25u_20u_Pipeline_VITIS_LOOP_149_7 is 
...
attribute shreg_extract : string;
    ...
    signal i_8_fu_68_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(connect_1_empty_n, connect_2_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((connect_2_full_n = ap_const_logic_0) or (connect_1_empty_n = ap_const_logic_0));
    end process;
    ...
    connect_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, connect_1_empty_n, ap_block_pp0_stage0)
    begin
    ...
    connect_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    connect_2_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, connect_2_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    connect_2_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_8_fu_68_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_7) + unsigned(ap_const_lv32_1));
    icmp_ln149_fu_62_p2 <= "1" when (ap_sig_allocacmp_i_7 = KER_bound) else "0";
end behav;
