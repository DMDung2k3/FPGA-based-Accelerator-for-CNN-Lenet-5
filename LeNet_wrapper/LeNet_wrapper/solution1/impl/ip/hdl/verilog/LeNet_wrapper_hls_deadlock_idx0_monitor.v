...
module LeNet_wrapper_hls_deadlock_idx0_monitor ( // for module LeNet_wrapper_LeNet_wrapper_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[9] = idx4_block & (1'b0 | axis_block_sigs[3] | axis_block_sigs[5] | axis_block_sigs[4]);
...
// instant sub module
 LeNet_wrapper_hls_deadlock_idx1_monitor LeNet_wrapper_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 LeNet_wrapper_hls_deadlock_idx4_monitor LeNet_wrapper_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
