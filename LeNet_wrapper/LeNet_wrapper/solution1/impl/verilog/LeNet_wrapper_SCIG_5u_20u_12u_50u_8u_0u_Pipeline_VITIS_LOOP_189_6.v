...
module LeNet_wrapper_SCIG_5u_20u_12u_50u_8u_0u_Pipeline_VITIS_LOOP_189_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((connect_4_full_n == 1'b0) | (connect_3_empty_n == 1'b0));
end
...
assign connect_4_din = connect_3_dout;

assign i_9_fu_68_p2 = (ap_sig_allocacmp_i + 32'd1);

assign icmp_ln189_fu_62_p2 = ((ap_sig_allocacmp_i == KER_bound) ? 1'b1 : 1'b0);

endmodule //LeNet_wrapper_SCIG_5u_20u_12u_50u_8u_0u_Pipeline_VITIS_LOOP_189_6
