...
entity LeNet_wrapper_pool_2u_50u_8u_Pipeline_VITIS_LOOP_194_13 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of LeNet_wrapper_pool_2u_50u_8u_Pipeline_VITIS_LOOP_194_13 is 
...
attribute shreg_extract : string;
    ...
    signal i_2_fu_68_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(connect_5_empty_n, connect_6_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((connect_6_full_n = ap_const_logic_0) or (connect_5_empty_n = ap_const_logic_0));
    end process;
    ...
    connect_5_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, connect_5_empty_n, ap_block_pp0_stage0)
    begin
    ...
    connect_5_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    connect_6_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, connect_6_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    connect_6_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_2_fu_68_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv32_1));
    icmp_ln194_fu_62_p2 <= "1" when (ap_sig_allocacmp_i_1 = KER_bound) else "0";
end behav;
